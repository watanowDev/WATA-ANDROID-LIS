        ...
        try {
            for (String camera : cameraManager.getCameraIdList()) {
                ...
                for (int capability : capabilities) {
                    ...
                    Log.i(TAG, "Camera : " + camera + ", REQUEST_AVAILABLE_CAPABILITIES_DEPTH_OUTPUT : " + capability);
                    depthCapable = depthCapable || capable;
                }

                facingFront = true;
                Log.i(TAG, "Camera : " + camera + ", depthCapable : " + depthCapable);
                if (depthCapable && facingFront) {
                    ...
                    Log.i(TAG, "Sensor size: " + sensorSize);       // Note 10 plus : 3.2 x 2.4
